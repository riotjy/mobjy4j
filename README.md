...
**mobjy** is intended to be extended to support other languages too (golang, python, etc...) and also multiple approaches for the same language.
For example in addition the the C++11 compatible code currently generated by the too, future C++ code may include optimizatoins for C++14/17/20.
